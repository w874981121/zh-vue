...
import {
  getScrollTop,
  getElementTop as _getElementTop,
  getRootScrollTop,
  setRootScrollTop,
...
export default createComponent({
  ...
  methods: {
    onScroll: function onScroll() {
      ...
      if (this.activeAnchorIndex && this.activeAnchorIndex !== this.memory) {
        this.memory = this.activeAnchorIndex
        this.$emit('handover', this.activeAnchorIndex);
      }
    ...
    scrollToElement: function scrollToElement(element) {
      ...
      var match = this.children.filter(function (item) {
        return String(item.index) === String(index);
      });
      if (match[0]) {
